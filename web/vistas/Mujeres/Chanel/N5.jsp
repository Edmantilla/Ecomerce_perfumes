    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Nï¿½5</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/CHANEL.avif" alt="Nï¿½5"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">360.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una de las fragancias mas iconicas y reconocidas del mundo, lanzada en 1921 por la casa de moda francesa Chanel.</p>
                    <div class="section-losion__divicion__description__type"><h2>TIPO</h2><p>EAU DE PARFUM</p></div>
                    <div class="section-losion__divicion__description__type"><h2>FAMILIA OLFATIVA</h2><p>FLORAL ALDEHï¿½DICA</p></div>
                    <div class="section-losion__divicion__description__type"><h2>MARCA</h2><p>CHANEL</p></div>
                    <div class="section-losion__divicion__description__notes"><P>Chanel Nï¿½5 es la esencia de la feminidad. Un bouquet floral abstracto compuesto alrededor de la rosa de mayo y el jazmin.</P></div>
                </div>
            </div>
