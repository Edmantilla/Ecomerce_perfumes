...
<head>
    ...
    <title>Chance Eau Fraï¿½che - Chanel</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                <div class="section-losion__contenedor2"><h2><a class="section-losion__titulo2" href="../../Chanel.jsp">CHANEL</a></h2></div>
                <h2 class="section-losion__title">Chance Eau Fraï¿½che</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/CHANCE EAU FRAICHE.avif" alt="Chance Eau Fraï¿½che"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">490.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia femenina lanzada en 2007 que se distingue por su caracter vibrante, fresco y energizante.</p>
                    <div class="section-losion__divicion__description__type"><h2>TIPO</h2><p>EAU DE TOILETTE</p></div>
                    <div class="section-losion__divicion__description__type"><h2>FAMILIA OLFATIVA</h2><p>CHIPRE FLORAL</p></div>
                    <div class="section-losion__divicion__description__type"><h2>MARCA</h2><p>CHANEL</p></div>
                    <div class="section-losion__divicion__description__notes"><P>Chance Eau Fraiche es una explosion de energia vibrante. La frescura chispeante de un citrico se encuentra con la suavidad del jazmin.</P></div>
                </div>
            </div>
        ...
        <section class="cards-lociones">
            <article class="card">
                <a href="N5.jsp">
                    <img class="card__img" src="../../../assets/imagenes/CHANEL.avif" alt="Nï¿½5">
                </a>
                <div class="card__content">
                    <h2 class="card__title">Nï¿½5</h2>
                    <h3 class="card__subtitle">Perfume</h3>
                    <p class="card__description">Una de las fragancias mas iconicas y reconocidas del mundo, lanzada en 1921 por la casa de moda f...</p>
                    <p class="card__quantity">50 ml - 100 ml</p>
                    <p class="card__price">360.000 COP</p>
                </div>
            </article>            <article class="card">
                <a href="Coco_Mademoiselle.jsp">
                    <img class="card__img" src="../../../assets/imagenes/COCO CHANEL.avif" alt="Coco Mademoiselle">
                </a>
                <div class="card__content">
                    <h2 class="card__title">Coco Mademoiselle</h2>
                    <h3 class="card__subtitle">Perfume</h3>
                    <p class="card__description">Una fragancia femenina lanzada por Chanel en 2001 que representa la elegancia moderna, fresca y a...</p>
                    <p class="card__quantity">50 ml - 100 ml</p>
                    <p class="card__price">410.000 COP</p>
                </div>
            </article>            <article class="card">
                <a href="Chance_Eau_Splendide.jsp">
                    <img class="card__img" src="../../../assets/imagenes/CHANEL EAU SPLENDIDE.avif" alt="Chance Eau Splendide">
                </a>
                <div class="card__content">
                    <h2 class="card__title">Chance Eau Splendide</h2>
                    <h3 class="card__subtitle">Perfume</h3>
                    <p class="card__description">Una fragancia femenina de la linea Chance de Chanel que evoca frescura, alegria y un espiritu vib...</p>
                    <p class="card__quantity">50 ml - 100 ml</p>
                    <p class="card__price">480.000 COP</p>
                </div>
            </article>            <article class="card">
                <a href="Chance_Eau_Tendre.jsp">
                    <img class="card__img" src="../../../assets/imagenes/CHANCE EAU TENDRE.avif" alt="Chance Eau Tendre">
                </a>
                <div class="card__content">
                    <h2 class="card__title">Chance Eau Tendre</h2>
                    <h3 class="card__subtitle">Perfume</h3>
                    <p class="card__description">Una fragancia femenina de Chanel que destaca por su aroma delicado, fresco y romantico.</p>
                    <p class="card__quantity">50 ml - 100 ml</p>
                    <p class="card__price">460.000 COP</p>
                </div>
            </article>            <article class="card">
                <a href="Chance_Eau_Fraiche.jsp">
                    <img class="card__img" src="../../../assets/imagenes/CHANCE EAU FRAICHE.avif" alt="Chance Eau Fraï¿½che">
                </a>
                <div class="card__content">
                    <h2 class="card__title">Chance Eau Fraï¿½che</h2>
                    <h3 class="card__subtitle">Perfume</h3>
                    <p class="card__description">Una fragancia femenina lanzada en 2007 que se distingue por su caracter vibrante, fresco y energi...</p>
                    <p class="card__quantity">50 ml - 100 ml</p>
                    <p class="card__price">490.000 COP</p>
                </div>
            </article>            <article class="card">
                <a href="Chance.jsp">
                    <img class="card__img" src="../../../assets/imagenes/CHANCE.avif" alt="Chance">
                </a>
                <div class="card__content">
                    <h2 class="card__title">Chance</h2>
                    <h3 class="card__subtitle">Perfume</h3>
                    <p class="card__description">Una fragancia femenina lanzada por Chanel en 2003 que simboliza energia, elegancia y espiritu audaz.</p>
                    <p class="card__quantity">50 ml - 100 ml</p>
                    <p class="card__price">460.000 COP</p>
                </div>
            </article>            <article class="card">
                <a href="Gabrielle_Chanel.jsp">
                    <img class="card__img" src="../../../assets/imagenes/GABRIELLE CHANEL.avif" alt="Gabrielle Chanel">
                </a>
                <div class="card__content">
                    <h2 class="card__title">Gabrielle Chanel</h2>
                    <h3 class="card__subtitle">Perfume</h3>
                    <p class="card__description">Una fragancia femenina luminosa, floral y sofisticada, compuesta por una armoniosa mezcla de jazm...</p>
                    <p class="card__quantity">50 ml - 100 ml</p>
