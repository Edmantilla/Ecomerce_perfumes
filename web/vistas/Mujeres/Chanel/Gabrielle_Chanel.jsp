...
<head>
    ...
    <title>Gabrielle Chanel - Chanel</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Gabrielle Chanel</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/GABRIELLE CHANEL.avif" alt="Gabrielle Chanel"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">510.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia femenina luminosa, floral y sofisticada, compuesta por una armoniosa mezcla de jazmin, ylang-ylang, flor de azahar y nardo.</p>
                    <div class="section-losion__divicion__description__type"><h2>TIPO</h2><p>EAU DE PARFUM</p></div>
                    <div class="section-losion__divicion__description__type"><h2>FAMILIA OLFATIVA</h2><p>FLORAL</p></div>
                    <div class="section-losion__divicion__description__type"><h2>MARCA</h2><p>CHANEL</p></div>
                    <div class="section-losion__divicion__description__notes"><P>Gabrielle Chanel es la fragancia de una mujer radiante que se expresa plenamente. Una flor imaginaria, luminosa y solar.</P></div>
                </div>
            </div>
