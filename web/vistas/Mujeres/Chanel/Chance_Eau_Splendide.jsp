...
<head>
    ...
    <title>Chance Eau Splendide - Chanel</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Chance Eau Splendide</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/CHANEL EAU SPLENDIDE.avif" alt="Chance Eau Splendide"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">480.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia femenina de la linea Chance de Chanel que evoca frescura, alegria y un espiritu vibrante.</p>
                    <div class="section-losion__divicion__description__type"><h2>TIPO</h2><p>EAU DE TOILETTE</p></div>
                    <div class="section-losion__divicion__description__type"><h2>FAMILIA OLFATIVA</h2><p>FLORAL FRUTAL</p></div>
                    <div class="section-losion__divicion__description__type"><h2>MARCA</h2><p>CHANEL</p></div>
                    <div class="section-losion__divicion__description__notes"><P>Chance Eau Splendide es una ola de frescura tonificante. Un torbellino floral que te arrastra hacia la fantasia.</P></div>
                </div>
            </div>
