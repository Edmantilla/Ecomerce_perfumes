...
<head>
    ...
    <title>Miss Dior Essence - Christian Dior</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Miss Dior Essence</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/MISS DIOR.jpg" alt="Miss Dior Essence"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <p>Una fragancia floral-chipre intensa con apertura jugosa de mora y sauco, corazon de jazmin sambac y base amaderada de roble.</p>
                    ...
                    <div class="section-losion__divicion__description__notes"><P>Miss Dior es un himno al amor. Una feminidad sensual y audaz.</P></div>
                </div>
            </div>
