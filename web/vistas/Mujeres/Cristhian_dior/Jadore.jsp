...
<head>
    ...
    <title>J'adore - Christian Dior</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">J'adore</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/J'adore Eau de Parfum.jpg" alt="J'adore"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">450.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia femenina que despliega un bouquet perfectamente equilibrado de ylang-ylang solar, rosa damascena y jazmin.</p>
                    ...
                    <div class="section-losion__divicion__description__notes"><P>J'adore es el gran floral femenino de Dior. Un bouquet minuciosamente elaborado como una flor hecha a medida.</P></div>
                </div>
            </div>
