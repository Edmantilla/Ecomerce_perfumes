...
<head>
    ...
    <title>Invictus - Paco Rabanne</title>
</head>
    ...
    <main class="main-losion">
        ...
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Invictus</h2>
            </div>
                ...
                <div class="section-losion__divicion__description">
                    <div class="section-losion__divicion__description__img">
                        ...
                        <div  class="section-losion__divicion__description__precios">
                            ...
                            <h2 class="section-losion__divicion__description__precios__precios">860.000 COP</h2>
                        </div>

                        <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                        <p>Una fragancia masculina fresca y energica que mezcla notas citricas y acuaticas con un corazon aromatico y una base amaderada, ofreciendo un aroma vigoroso, moderno y seductor.</p>
                        ...
                        <div class="section-losion__divicion__description__notes">
                            <P>Invictus es el aroma del campeon. Inspirado en el trofeo olimpico, esta fragancia fresca y acuatica transmite confianza, vitalidad y poder en cada gota.
                            </P>
                        </div>
