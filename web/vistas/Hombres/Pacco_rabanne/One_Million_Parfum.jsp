...
<head>
    ...
    <title>One Million Parfum - Paco Rabanne</title>
</head>
    ...
    <main class="main-losion">
        ...
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">One Million Parfum</h2>
            </div>
            ...
            <div class="section-losion__divicion">
                ...
                <div class="section-losion__divicion__img">
                    <img src="" alt="One Million Parfum">
                    <img src="" alt="">
                </div>
                ...
                <div class="section-losion__divicion__description">
                    <div class="section-losion__divicion__description__img">
                        ...
                        <div  class="section-losion__divicion__description__precios">
                            ...
                            <h2 class="section-losion__divicion__description__precios__precios">620.000 COP</h2>
                        </div>

                        <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                        <p>Una fragancia masculina elegante y moderna que combina notas citricas y especiadas con un corazon calido de cuero y maderas, creando un aroma sofisticado, audaz y duradero.</p>
                        ...
                        <div class="section-losion__divicion__description__notes">
                            <P>One Million Parfum es una reinterpretacion atemporal del clasico One Million. Con mayor concentracion y longevidad, ofrece una experiencia olfativa mas profunda y compleja para el hombre contemporaneo.
                            </P>
                        </div>
