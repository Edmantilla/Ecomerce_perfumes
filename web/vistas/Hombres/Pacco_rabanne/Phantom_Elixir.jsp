...
<head>
    ...
    <title>Phantom Elixir - Paco Rabanne</title>
</head>
    ...
    <main class="main-losion">
        ...
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Phantom Elixir</h2>
            </div>
            ...
            <div class="section-losion__divicion">
                ...
                <div class="section-losion__divicion__description">
                    <div class="section-losion__divicion__description__img">
                        ...
                        <p>Una fragancia masculina intensa y adictiva que mezcla notas aromaticas frescas con matices dulces y amaderados para un aroma moderno, sofisticado y memorable.</p>
                        ...
                        <div class="section-losion__divicion__description__notes">
                            <P>Phantom Elixir es la version mas oscura y seductora del Phantom original. Una concentracion superior que intensifica cada nota, haciendo que la fragancia persiste horas en la piel.
                            </P>
                        </div>
