...
<!-- Página de detalle de la loción LIRA -->
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Lira</h2>
            </div>

            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img">
                    <img src="" alt="Imagen de la loción Lira">
                    <img src="" alt="">
                </div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">1.000.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia unisex amaderada y afrutada que combina cítricos brillantes con notas florales
                        suaves y una base cálida de maderas y almizcle.</p>
        ...
        <section class="cards-lociones">
            ...
            <article class="card">
                <a href="Alexandria_II.jsp"><img class="card__img" src="../../../assets/imagenes/ALEXANDRIA 2.webp"
                        alt="Alexandria II"></a>
                <div class="card__content">
            ...
            <article class="card">
                <a href="Erba_Gold.jsp"><img class="card__img" src="../../../assets/imagenes/ERBA GOLD.webp"
                        alt="Erba Gold"></a>
                <div class="card__content">
            ...
            <article class="card">
                <a href="Homme.jsp"><img class="card__img" src="../../../assets/imagenes/HOMME.webp" alt="Homme"></a>
                <div class="card__content">
