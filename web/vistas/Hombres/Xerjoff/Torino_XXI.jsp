...
<!-- Página de detalle de la loción TORINO XXI -->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Torino XXI - Xerjoff</title>
</head>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Torino XXI</h2>
            </div>

            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img">
                    <img src="" alt="Imagen de la loción Torino XXI">
                    <img src="" alt="">
                </div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">1.300.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia unisex fresca y verde aromática inspirada en la energía vibrante de Turín y el
                        espíritu deportivo.</p>
