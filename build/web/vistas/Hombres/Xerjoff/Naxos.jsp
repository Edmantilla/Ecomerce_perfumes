...
<!-- Página de detalle de la loción NAXOS -->
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <!-- Contenido Principal: Detalle de la Loción -->
    <main class="main-losion">
        ...
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Naxos</h2>
            </div>
            ...
            <div class="section-losion__divicion">
                ...
                <div class="section-losion__divicion__img">
                    <img src="" alt="Imagen de la loción Naxos">
                    <img src="" alt="">
                </div>
                ...
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">1.120.000 COP</h2>
                    </div>

                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia unisex de la familia cítrica gourmand que celebra la riqueza y la luz del
                        Mediterráneo.</p>
                    ...
                    <div class="section-losion__divicion__description__notes">
                        <P>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas ullam quidem facere laboriosam
                            unde, inventore reprehenderit est tempore sint hic. Unde eaque nemo sunt magnam illum soluta
                            velit amet obcaecati.
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi at illum placeat atque
                            deleniti incidunt, dolore cum quam nesciunt nostrum quia, ipsa est eos fugiat quod aliquid
                            vel, voluptate sint.
                        </P>
                    </div>
        ...
        <section class="cards-lociones">
            ...
            <article class="card">
                ...
                <div class="card__content">
                    ...
                    <h3 class="card__subtitle">Perfume</h3>
                    <p class="card__description">Una fragancia unisex de la familia amaderada y ámbar oriental.
                    </p>
                    <p class="card__quantity">50 ml - 100 ml</p>
            ...
            <article class="card">
                ...
                <div class="card__content">
                    ...
                    <p class="card__description">Una fragancia unisex amaderada y afrutada que combina cítricos
                        brillantes con notas florales suaves.
                    </p>
                    <p class="card__quantity">50 ml - 100 ml</p>
                    <p class="card__price">1.000.000 COP</p>
                </div>
