...
<!-- Página de detalle de la loción ERBA PURA -->
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="main-losion">
        ...
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Erba Pura</h2>
            </div>

            <div class="section-losion__divicion">

                <div class="section-losion__divicion__img">
                    <img src="" alt="Imagen de la loción Erba Pura">
                    <img src="" alt="">
                </div>
                ...
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">1.500.000 COP</h2>
                    </div>

                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia unisex vibrante y frutal con apertura cítrica de naranja, limón y bergamota.</p>
        ...
        <section class="cards-lociones">
            ...
            <article class="card">
                ...
                <div class="card__content">
                    ...
                    <p class="card__description">Una fragancia unisex de la familia cítrica gourmand que celebra la
                        riqueza y la luz del Mediterráneo.</p>
                    <p class="card__quantity">50 ml - 100 ml</p>
            ...
            <article class="card">
                ...
                <div class="card__content">
                    ...
                    <h3 class="card__subtitle">Perfume</h3>
                    <p class="card__description">Una fragancia unisex de la familia amaderada y ámbar oriental.</p>
                    <p class="card__quantity">50 ml - 100 ml</p>
