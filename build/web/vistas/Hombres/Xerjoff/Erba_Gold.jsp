...
<!-- Página de detalle de la loción ERBA GOLD -->
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Erba Gold</h2>
            </div>

            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img">
                    <img src="" alt="Imagen de la loción Erba Gold">
                    <img src="" alt="">
                </div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">1.600.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia unisex fresca y luminosa que mezcla cítricos vibrantes y frutas dulces sobre una
                        base cálida de almizcle y ámbar.</p>
