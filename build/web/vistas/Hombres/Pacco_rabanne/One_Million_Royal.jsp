...
<head>
    ...
    <title>One Million Royal - Paco Rabanne</title>
</head>
    ...
    <main class="main-losion">
        ...
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">One Million Royal</h2>
            </div>
                ...
                <div class="section-losion__divicion__description">
                    <div class="section-losion__divicion__description__img">
                        ...
                        <div  class="section-losion__divicion__description__precios">
                            ...
                            <h2 class="section-losion__divicion__description__precios__precios">720.000 COP</h2>
                        </div>

                        <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                        <p>Una fragancia masculina intensa y elegante que combina notas especiadas y amaderadas con un corazon dulce y oriental, creando un aroma sofisticado, lujoso y seductor.</p>
                        ...
                        <div class="section-losion__divicion__description__notes">
                            <P>One Million Royal es la version mas exclusiva y sofisticada de la coleccion. Sus notas orientales y especiadas le dan un caracter unico que lo convierte en la eleccion perfecta para ocasiones especiales.
                            </P>
                        </div>
