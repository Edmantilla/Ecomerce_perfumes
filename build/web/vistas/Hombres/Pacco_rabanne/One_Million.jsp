...
<head>
    ...
    <title>One Million - Paco Rabanne</title>
</head>
    ...
    <main class="main-losion">
        ...
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">One Million</h2>
            </div>
                ...
                <div class="section-losion__divicion__description">
                    <div class="section-losion__divicion__description__img">
                        ...
                        <div  class="section-losion__divicion__description__precios">
                            ...
                            <h2 class="section-losion__divicion__description__precios__precios">500.000 COP</h2>
                        </div>

                        <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                        <p>Una fragancia masculina atrevida y distintiva que mezcla notas citricas y especiadas con un corazon floral y una base calida de cuero y maderas, ofreciendo un aroma lujoso, seductor y moderno.</p>
                        ...
                        <div class="section-losion__divicion__description__notes">
                            <P>One Million es un icono de la perfumeria moderna. Desde su lanzamiento ha conquistado millones de corazones con su aroma dorado, lujoso y arrebatador que combina lo mejor de los citricos y el cuero.
                            </P>
                        </div>
