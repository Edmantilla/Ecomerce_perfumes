...
<head>
    ...
    <title>One Million Lucky - Paco Rabanne</title>
</head>
    ...
    <main class="main-losion">
        ...
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">One Million Lucky</h2>
            </div>
                ...
                <div class="section-losion__divicion__description">
                    <div class="section-losion__divicion__description__img">
                        ...
                        <div  class="section-losion__divicion__description__precios">
                            ...
                            <h2 class="section-losion__divicion__description__precios__precios">830.000 COP</h2>
                        </div>

                        <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                        <p>Una fragancia masculina dulce y amaderada que combina notas de avellana y ciruela con un corazon de jazmin y pachuli, creando un aroma moderno, seductor y lleno de energia.</p>
                        ...
                        <div class="section-losion__divicion__description__notes">
                            <P>One Million Lucky celebra la suerte y la audacia. Una fragancia que atrae la buena fortuna con su mezcla irresistible de frutos dulces y maderas sensuales.
                            </P>
                        </div>
