...
<head>
    ...
    <title>Dior Addict Rosy Glow - Christian Dior</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Dior Addict Rosy Glow</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/Dior Addict Rosy Glow.webp" alt="Dior Addict Rosy Glow"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <p>Una fragancia floral-afrutada delicada y luminosa que combina esencia de rosa damascena con toques brillantes de lichi.</p>
                    ...
                    <div class="section-losion__divicion__description__notes"><P>Dior Addict es una declaracion de amor a la vida. Una fragancia que vibra con energia.</P></div>
                </div>
            </div>
