...
<head>
    ...
    <title>Poison - Christian Dior</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Poison</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/poison.jpg" alt="Poison"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <p>Una fragancia femenina iconica, intensa y misteriosa que combina notas frutales de ciruela y especias con un corazon floral profundo.</p>
                    ...
                    <div class="section-losion__divicion__description__notes"><P>Poison es una fragancia revolucionaria que se ha convertido en leyenda. Un mito de la seduccion.</P></div>
                </div>
            </div>
