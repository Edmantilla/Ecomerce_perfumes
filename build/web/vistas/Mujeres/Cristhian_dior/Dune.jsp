...
<head>
    ...
    <title>Dune - Christian Dior</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Dune</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/dune.webp" alt="Dune"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">520.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia femenina de estilo aromatico-amaderado que evoca la serenidad y el misterio de los paisajes naturales.</p>
                    <div class="section-losion__divicion__description__type"><h2>TIPO</h2><p>EAU DE TOILETTE</p></div>
                    <div class="section-losion__divicion__description__type"><h2>FAMILIA OLFATIVA</h2><p>ORIENTAL AMADERADA</p></div>
                    <div class="section-losion__divicion__description__type"><h2>MARCA</h2><p>CRISTIAN DIOR</p></div>
                    <div class="section-losion__divicion__description__notes"><P>Dune simboliza la evasion hacia el mundo de los sueï¿½os donde solo reina la paz. Un lugar donde el sol besa el mar.</P></div>
                </div>
            </div>
