...
<head>
    ...
    <title>Pure Poison - Christian Dior</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Pure Poison</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/Pure Poison.jpg" alt="Pure Poison"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <p>Una fragancia femenina floral-amaderada luminosa y moderna que combina notas blancas de jazmin, bergamota y maderas suaves.</p>
                    <div class="section-losion__divicion__description__type"><h2>TIPO</h2><p>EAU DE PARFUM</p></div>
                    <div class="section-losion__divicion__description__type"><h2>FAMILIA OLFATIVA</h2><p>FLORAL AMADERADA</p></div>
                    <div class="section-losion__divicion__description__type"><h2>MARCA</h2><p>CRISTIAN DIOR</p></div>
                    <div class="section-losion__divicion__description__notes"><P>Pure Poison encarna la seduccion en estado puro. Una fragancia de una inocencia cautivadora.</P></div>
                </div>
            </div>
