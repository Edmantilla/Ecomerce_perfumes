...
<head>
    ...
    <title>Chance Eau Tendre - Chanel</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Chance Eau Tendre</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/CHANCE EAU TENDRE.avif" alt="Chance Eau Tendre"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <p>Una fragancia femenina de Chanel que destaca por su aroma delicado, fresco y romantico.</p>
                    ...
                    <div class="section-losion__divicion__description__notes"><P>Chance Eau Tendre es la interpretacion mas suave de Chance. Un perfume delicado como un poema floral.</P></div>
                </div>
            </div>
