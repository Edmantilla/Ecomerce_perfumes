...
<head>
    ...
    <title>Coco Mademoiselle - Chanel</title>
</head>
<body>
    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Coco Mademoiselle</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/COCO CHANEL.avif" alt="Coco Mademoiselle"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <div class="section-losion__divicion__description__precios">
                        ...
                        <h2 class="section-losion__divicion__description__precios__precios">410.000 COP</h2>
                    </div>
                    <button class="section-losion__divicion__description__button">AGREGAR AL CARRITO</button>
                    <p>Una fragancia femenina lanzada por Chanel en 2001 que representa la elegancia moderna, fresca y audaz de la mujer contemporanea.</p>
                    <div class="section-losion__divicion__description__type"><h2>TIPO</h2><p>EAU DE PARFUM</p></div>
                    <div class="section-losion__divicion__description__type"><h2>FAMILIA OLFATIVA</h2><p>ORIENTAL FLORAL</p></div>
                    <div class="section-losion__divicion__description__type"><h2>MARCA</h2><p>CHANEL</p></div>
                    <div class="section-losion__divicion__description__notes"><P>Coco Mademoiselle es la esencia de una mujer libre y audaz. Una oriental de caracter firme y frescura sorprendente.</P></div>
                </div>
            </div>
