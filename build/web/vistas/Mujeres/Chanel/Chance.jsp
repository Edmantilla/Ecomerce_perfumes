    ...
    <main class="main-losion">
        <section class="section-losion-perfumes">
            <div class="section-losion__contenedor">
                ...
                <h2 class="section-losion__title">Chance</h2>
            </div>
            <div class="section-losion__divicion">
                <div class="section-losion__divicion__img"><img src="../../../assets/imagenes/CHANCE.avif" alt="Chance"><img src="" alt=""></div>
                <div class="section-losion__divicion__description">
                    ...
                    <p>Una fragancia femenina lanzada por Chanel en 2003 que simboliza energia, elegancia y espiritu audaz.</p>
                    ...
                    <div class="section-losion__divicion__description__notes"><P>Chance es un perfume impredecible, en constante movimiento. Una fragancia floral en la que se entrelazan la pimienta rosa, el jazmin y el pachuli ambarino.</P></div>
                </div>
            </div>
